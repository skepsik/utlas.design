...
- Scratchpad (отдельно): [scratchpad](../envelope/scratchpad.md) — `scratchpad_search_rule` при совместном compose
...
Runner возвращает [ToolRunResult](./composite.md) ([#68](https://github.com/skepsik/utlas-ts/issues/68)): `result` + `block` (`kind: message_search`, `initialTtl` ← `ttlTurns`).
...
| Scratchpad | рабочий остаток (decisions, constraints, …) |
